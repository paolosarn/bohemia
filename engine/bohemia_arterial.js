...
(function (root) {
  ...
  var AMEN = 52;       // 47..52 amenity strip (streetlights live here)
  // SIDE A LITTLE, THEN STREET (Paolo 8/11, his words exactly): "THE STREET WILL TAKE UP
  // THE full fucking square not just most of it... side a little then street!" The walk
  // runs to the cell boundary and there is no margin behind it at all -- the neighbouring
  // district's own edge is what starts on the other side of the line.
  var WALK = 63;       // 53..63 DETACHED sidewalk, out to the cell edge
  var SET = 63;        // no margin: the street owns the cell
