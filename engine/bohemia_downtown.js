...
(function(root){
  ...
  var LEGEND={
    ...
    3:{name:'street tree',        kind:'tree-dead',act1:'a dead street tree still standing in its grate, trunk split, the iron grate itself long since prised up', solid:true},
