...
(function(root){
  ...
  function dress(G, yard){
    for(var round=0; round<24 && topShare(G)>0.27; round++) dressRound(G, yard);
  }
  function dressRound(G, yard){
    var W=G.W,H=G.H,r=G.rnd,i,j;
    ...
    for(i=0;i<70;i++){ var bx=6+Math.floor(r()*(W-12)), by=8+Math.floor(r()*(H-16));
  ...
  var LAY = {
    ...
    pit: function(G,p){
      ...
      if(p.dome){                                                // PABCO's monolithic storage dome
        ...
        G.disc(Math.round(W*0.20), Math.round(H*0.78), 12, 7);
    ...
    ponds: function(G,p){
      var W=G.W,H=G.H,i,j;
      var cols=3, rows=3, pw=30, ph=24, x0=14, y0=18;
      for(j=0;j<rows;j++)for(i=0;i<cols;i++){
  ...
  var SPECS = {
    ...
    quarry: { lay:'pit', par:{benches:4}, cat:'infrastructure', yard:4,
      ...
      leg:{0:['desert dead-ground','ground','the untouched desert outside the quarry line'],
           ...
           7:['bench lip / crest','structure','the crest of the bench, loose rock along the edge where nobody has scaled it'],
           ...
           11:['marking','marking','faded hazard paint on the plant floor'],
    ...
    gypsum: { lay:'pit', par:{benches:3, dome:true}, cat:'infrastructure', yard:4,
      ...
      leg:{0:['desert dead-ground','ground','bare Mojave outside the mine line, and the white dust reaches a long way past it'],
           ...
           7:['bench lip / dome shell','structure','the crest of a bench — or the shell of the storage dome, a hemisphere of shotcrete'],
           ...
           11:['marking','marking','faded hazard paint on the mill floor'],
    ...
    fueldepot: { lay:'tanks', par:{cols:3, rows:2, rad:13, dikes:true, rack:true}, cat:'industrial', yard:4,
      ...
      leg:{0:['dead-ground (setback)','ground','the setback outside the terminal fence, kept clear because of what is stored inside it'],
           ...
           9:['pole light','prop','a terminal yard light, head dark'],
    ...
    reservoir: { lay:'tanks', par:{cols:2, rows:1, rad:20, dikes:false, rack:false}, cat:'infrastructure', yard:4,
      ...
      leg:{0:['dead-ground (setback)','ground','the hillside outside the reservoir fence'],
           ...
           9:['pole light','prop','a pad light, head dark'],
           ...
           14:['standpipe','structure','the standpipe beside the tanks']},
    ...
    intake: { lay:'pumps', par:{water:true}, cat:'infrastructure', yard:4,
      ...
      leg:{0:['dead-ground (setback)','ground','the bare shore above the old waterline, and it was underwater when this was built'],
           ...
           13:['intake shaft / main','structure','the shaft down to the tunnel, and the main leaving the pump house'],
    ...
    granary: { lay:'silos', par:{count:9}, cat:'industrial', yard:4,
    ...
    reclaim: { lay:'ponds', par:{}, cat:'infrastructure', yard:4,
      ...
      leg:{0:['dead-ground (setback)','ground','the setback outside the pond field, and downwind of it, which is why nobody built here'],
           ...
           5:['gate','gate','the plant gate off the street, amber curb'],
           6:['crusted pond centre','structure','the crust in the middle of a pond, dried hard enough to walk on and not hard enough to trust'],
           ...
           11:['marking','marking','pond number stencilled on a weir box'],
    ...
    radio: { lay:'masts', par:{}, cat:'infrastructure', yard:4,
      ...
      leg:{0:['dead-ground (setback)','ground','ridge ground outside the fence, too steep and too high up for anything but this'],
           ...
           11:['marking','marking','call letters stencilled on a hut door'],
