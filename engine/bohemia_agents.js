  ...
  function agentsForBlock(blockSeed, feet, jobs, fpOf, opts){
    ...
    if(opts.households>0 && feet.length){
      /* THE DIAL STILL HAS THE LAST WORD, even over a named count. Two of his
         ...
         of the slider is a lie.

         *** AND ON 8/28 THIS LANE MOVED THE DEFAULT DIAL AND TURNED HIS FOUR
         FAMILIES INTO EIGHTEEN. *** The count was scaled against the LITERAL
         dial, so "four at 1" was only ever true while the default WAS 1. The
         population row then moved the default to LANDMARK.story -- for a good
         measured reason, his own design document says ~69,000 and the game was
         shipping 4,194 -- and his starting block quietly went to 18 households
         and 47 people. people_gate's H1, H3 and H4 have been red ever since and
         its own comment records that HE ASKED TWICE for four.
         A DEFAULT IS NOT A NEUTRAL NUMBER: anything measured against 1 breaks
         the day 1 stops being the default, and nothing here said so out loud.
         So the count is scaled against THE DEFAULT rather than against 1. Four
         families at the shipped default, none at 0, eight at twice it -- which
         is what both rulings say, and it stays true whatever the default becomes
         next. */
