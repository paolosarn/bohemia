...
(function(root){
  ...
  var LEGEND={
    ...
    2:{name:'building (shelter/restroom)',kind:'building',act1:'weathered CMU + faded metal-roof picnic shelter / restroom block', enter:'restroom stalls / an open-air picnic shelter (roof on posts) interior'},
    ...
    9:{name:'dead pond',          kind:'water-dead', act1:'empty dry basin, cracked mud floor, stone rim', layer:'ground', solid:false},
