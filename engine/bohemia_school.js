...
(function(root){
  ...
  function buildCanonical(seed){
    ...
    G.rect(48,53,58,55,11);                                  // the doors out to the field

    /* ---- PORTABLE CLASSROOMS, the overcrowding annex ---- */
    for(i=0;i<3;i++){ var py=6+i*11; G.rect(108,py,122,py+8,15); set(109,py+4,10); }
    ...
    /* ---- TENNIS COURTS, east of the gym ---- */
    for(i=0;i<2;i++){ var cy2=40+i*11;
      G.rect(86,cy2,120,cy2+9,8);
      for(x=87;x<=119;x++) set(x,cy2+5,10);
      G.rect(86,cy2,120,cy2,10); G.rect(86,cy2+9,120,cy2+9,10);
    }
