...
(function(root){
  ...
  var DRIVE=3, DVW=4, HW=M(14), HD=M(9), GARW=M(5), GARD=M(5), RD=Math.max(2,M(5)>>1), GAP=3, LOTW=M(14)+GAP+1;
  ...
  function generate(seed,style,cw,ch){
    ...
    var W=Wd(g),H=Ht(g), R=DRIVE+HD+GAP+1;                       // ring inset = home depth + a >=3 tile backyard to the wall
