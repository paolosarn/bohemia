...
(function(root){
  ...
  // only). Starts AT the rail ends (lo, hi) so a house lands in each corner, still
  // fed by the existing rail — no extra street (Paolo 7/18: fill the corners).
  function placeColOuter(g,streetX,dir,lo,hi){
    for(var ly=lo; ly<=hi; ly+=LOTW) home(g,(streetX+dir*RD)|0,ly,dir,0);
  }
