...
// 4. THE CITY TAB = THE ONE ISOMETRIC 45 VIEW (Paolo 7/25: one view, a zoom
// continuum - walk your character zoomed in, zoom OUT and it becomes the
// city-builder, zoom out further = the world; NOT separate flat maps). laws/
// BOHEMIA_ADDENDUM_CITYBUILDER_TOP_DOWN_ONLY_7_25_26.md. The build/demolish
// verbs live at the zoomed-out city level of THIS iso view; the standalone
// flat builder page (BOHEMIA_CITY_CURRENT.html) stays dormant, wired nowhere,
...
ok('the standalone flat builder page is wired NOWHERE in the alpha (its engine is reused, not the page)',
  alpha.indexOf('BOHEMIA_CITY_CURRENT.html') < 0);
