...
GATES = [
    ...
    ('PEOPLE GATHER', ['node', 'gates/people_gather_gate.js'],
     ...
     'row stays OPEN; it is the first number above zero this lane has measured on that '
     'walk. MEASURED GREEN 13/0 on the walked surface and in the cut demo. Mutation-tested '
     'four ways: delete the places (B1 red, 4 share a screen instead of 13, and B4 red), '
     ...
     'bearing (A3 and B1b red, 8 bearings collapsing to 3 places). THREE OF THOSE LEGS HAD '
     ...
     'A LEG THAT ASKS THE CASE THAT SOUNDS HARDEST IS STILL GUESSING.', False),
