...
const fs=require('fs');
const reg=JSON.parse(fs.readFileSync(__dirname+'/../banks/BOHEMIA_ACT1_LIGHT_SOURCES_v5_7_16_26.txt','utf8'));
...
fs.writeFileSync(__dirname+'/../engine/_norm.json',JSON.stringify(N,null,1));
process.exit(f?1:0);
