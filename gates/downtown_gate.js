...
for(const cfg of CONFIGS)for(let s=1;s<=3;s++){const r=D.generate(s*17+3,{streets:cfg}),t=counts(r),g=r.g,W=g[0].length,H=g.length;
 if(!(t[2]>5000 && (t[6]||0)>500 && t[8]>1500 && t[1]>800 && (t[7]||0)>100 && (t[10]||0)>8 && (t[11]||0)>100 && (t[3]||0)>10 && (t[12]||0)>20))anatomy=false;
...
ok('podium blocks + towers + street grid + roundabout plaza + sidewalks + rooftop mech + crosswalks + trees + skybridge',anatomy);
