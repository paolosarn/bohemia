...
> **THIS NUMBER MOVES, AND THAT IS THE POINT.** It was **17** when written; after merging the same day's other lanes it was **22**. Nobody did anything wrong — new finished work keeps landing in the invisible file because nothing was watching. `python3 tools/bohemia_reachability_census.py` for the live count; `records/BOHEMIA_REACHABILITY_CENSUS.md` always holds it.
