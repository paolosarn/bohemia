...
| house skins + canon doors | INTEGRATED | art_banks | the approved 7/21 roof/yard/wall skins + the canon door bank, byte-identical |
...
| music (faction pools, 120 BPM) | NOT YET | — | the synth lives in the combat frame; the run is silent |
...
3. **DISTRICT ART** — the 21 built district types become places the errand can
   route him through.
4. **MUSIC** — the faction pools play while he walks.
5. **DAY CYCLE + LIGHT** — the lamps and the dark mean something.
