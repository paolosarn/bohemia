...
## J. ADMIN
- STATUS: CANDIDATES COOKED 8/9/26 (was OPEN; bank: banks/tileforms/TF-ART-008_CANDIDATES_8_8_26.json, proofs: records/tileforms_proofs/TF-ART-008/, judge: the ART tab, TILE BOARD card). UNJUDGED until Paolo thumbs it. | REQUESTED BY: ART lane (own queue, breaking down board row 7)
