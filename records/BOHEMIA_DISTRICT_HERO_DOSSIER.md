...
## CITYHALL  (494x507, anchor 256,379)
...
## BATTERY  (494x383, anchor 256,379)
...
## TERMINAL  (494x451, anchor 256,378)
...
## DOWNTOWN  (494x507, anchor 256,378)
...
## INDUSTRIAL  (494x408, anchor 256,377)
...
## MEDICAL  (494x429, anchor 256,379)
...
## WAREHOUSE  (494x313, anchor 255,378)
...
## COMMERCIAL  (494x375, anchor 256,378)
...
## COURTHOUSE  (494x507, anchor 256,378)
...
## LIBRARY  (494x437, anchor 256,377)
...
## FIRESTATION  (494x507, anchor 256,376)
...
## POLICESTATION  (494x377, anchor 255,378)
...
## STADIUM  (494x454, anchor 256,378)
...
## STORAGE  (494x333, anchor 255,378)
...
## TRUCKSTOP  (494x349, anchor 255,378)
...
## SWAPMEET  (494x356, anchor 255,378)
...
## INTERCHANGE  (494x327, anchor 256,385)
...
## SPEEDWAY  (494x370, anchor 256,379)
...
## BALLPARK  (494x430, anchor 256,379)
...
## APARTMENT  (494x408, anchor 256,378)
...
## TRAILER  (494x332, anchor 255,379)
...
## CEMETERY  (494x307, anchor 256,378)
...
## LANDFILL  (494x375, anchor 256,378)
...
## RAILYARD  (494x467, anchor 255,378)
...
## SUBSTATION  (494x399, anchor 256,378)
...
## WATERTREAT  (494x329, anchor 256,379)
...
## WATERPARK  (494x376, anchor 255,378)
...
## DRIVEIN  (494x490, anchor 256,378)
...
## BONEYARD  (494x421, anchor 255,379)
...
## FREEWAY  (494x369, anchor 256,385)
...
## ARTERIAL  (494x385, anchor 256,385)
...
## ARTERIAL_X  (494x395, anchor 256,385)
...
## MOUNTAIN  (494x406, anchor 256,378)
...
## FUELDEPOT  (494x353, anchor 256,378)
_TANK FARM_
...
## RESERVOIR  (494x351, anchor 256,378)
_RESERVOIR_
...
## GRANARY  (494x473, anchor 255,378)
_GRAIN ELEVATOR_
...
## ARSENAL  (494x349, anchor 255,378)
_ARSENAL_
...
## DATAFORT  (494x429, anchor 262,375)
_DATA FORT_
...
## RECLAIM  (494x282, anchor 255,379)
_RECLAMATION PONDS_
...
## PUMPSTATION  (494x334, anchor 256,378)
_PUMP STATION_
