...
| 3 | `#4d4a38` | dead tree | tree-dead | a campus tree gone to stick, the irrigation that kept it long dead | prop | yes | — | 203 |
| 4 | `#524b38` | quad (dead lawn) | ground | the quad, brown to the root — in the Mojave the lawn is the first thing to die | ground | no | — | 6796 |
