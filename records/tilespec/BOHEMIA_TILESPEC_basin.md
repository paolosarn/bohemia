...
| 6 | `#5f5844` | side slope / outlet works | structure | the side slope stepping down to the floor — and the concrete outlet box at the bottom of it | structure | yes | — | 3608 |
...
| 11 | `#c9c1aa` | marking | marking | the elevation marks on the outlet box — the record of every flood that filled this | ground | no | — | — |
...
**Gate:** `gates/basin_gate.js` (+ the street-aware/drivable law via `district_kit_gate.js`).
