...
- BINS (code 14) beside the garage, or out at the kerb on the houses that had already rolled them out -- WHERE a bin stands is when this street stopped, and that is the premise of the whole valley said in one prop. Never on the one-grid walk and never on the driveway apron: a bin is solid, and in a one-wide walk that severs it. The put-out ratio is a mechanism default, not canon.
