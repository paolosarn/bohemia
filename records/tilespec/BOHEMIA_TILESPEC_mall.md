...
|---|---|---|---|---|---|---|---|---|
| 0 | `dead-dirt (kit ground)` | desert dead-ground | ground | bare Mojave dirt at the lot edge | ground | no | — | 1879 |
| 1 | `#33333c` | street / drive | drive | the cracked mall ring-road / driveway (car-drivable) | ground | no | — | 1999 |
| 2 | `#5c5648` | concourse | building | the enclosed mall concourse, tilt-up + glazing, most glass gone | structure | yes | concourse interior: a long dead promenade, storefronts dark on both sides | 1189 |
| 3 | `#4c4a33` | reclaimed ground | ground | the lot edge going back to the desert — asphalt broken into plates by forty summers, creosote and tumbleweed rooted in the joints, sand drifted over the kerb line. Nothing is resurfacing this | ground | no | — | 2521 |
| 4 | `#524c3e` | parking asphalt | drive | the parking field proper — asphalt still holding where the cars packed it down, striping ghosted to grey, oil shadows where the engines dripped | ground | no | — | 3175 |
| 5 | `#c79a3f` | gate | gate | the main driveway curb cut off the street, amber curb | portal | no | — | 9 |
| 6 | `#4a5766` | anchor store | building | a big-box anchor department store, sign faded, doors boarded | structure | yes | anchor store interior: a cavernous dead sales floor | 762 |
...
| 11 | `#c9c1aa` | stall marking | marking | faded parking-stall paint | ground | no | — | 510 |
| 12 | `#241f1a` | entrance door | portal | a mall entrance vestibule, glass smashed or boarded | portal | no | into the concourse | 7 |
