...
| 2 | `#6a5f50` | building (food hall / office) | building | the market hall / food court + office, roll doors seized, signage dead | structure | yes | market-hall interior: permanent indoor stalls + a food-court counter up front, storage behind | 224 |
| 3 | `#4a4030` | junk / debris pile | tree-dead | a knocked-over stall / a pile of picked-over junk + torn tarp | prop | no | — | 38 |
| 4 | `#b0a690` | stall canopy / tent | overhead | a vendor canopy / tent over a stall row — fabric bleached + torn, poles leaning (you walk UNDER it) | overhead | no | — | 1316 |
| 5 | `#c79a3f` | gate / entrance | gate | the market entrance off the street, amber curb, turnstile husks | portal | no | — | 9 |
| 6 | `#7a5a44` | vendor stall / table | prop | a vendor table / stall stand, goods long gone, some tipped | prop | yes | — | 228 |
| 7 | `#6f6656` | market aisle (packed-dirt walkway) | ground | the packed-dirt market aisle between the stall rows — the walkable grid | ground | no | — | 6358 |
...
| 10 | `#55555f` | abandoned car | vehicle | a car left in the gravel lot, tyres flat, dust-caked | prop | yes | — | 36 |
...
| 13 | `#a86a4a` | stall canopy / tent (red) | overhead | a faded red vendor canopy over a stall row — the market navigated by tent color (you walk UNDER it) | overhead | no | — | 1312 |
| 14 | `#5f7a72` | stall canopy / tent (teal) | overhead | a faded teal vendor canopy over a stall row — the market navigated by tent color (you walk UNDER it) | overhead | no | — | 647 |
