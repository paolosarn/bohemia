# BOHEMIA DISTRICT DOSSIER — AIRBASE
...
|---|---|---|---|---|---|---|---|---|
| 0 | `dead-dirt (kit ground)` | dead ground | ground | the graded infield between the pavements, gone to dust and weeds | ground | no | — | 4208 |
...
| 8 | `#7a7266` | terminal | building | the terminal block, glass dead dark, every door standing open | structure | yes | — | — |
| 9 | `#6a6a72` | hangar | building | a hangar, doors half open on nothing | structure | yes | — | 1652 |
...
**Gate:** `gates/airbase_gate.js` (+ the street-aware/drivable law via `district_kit_gate.js`).
