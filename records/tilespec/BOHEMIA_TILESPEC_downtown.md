...
| 4 | `#5b5343` | vacant parcel | ground | the parcel where a building came down and nothing replaced it — hardpan dirt and broken slab, its old footprint still printed in the ground, sun-bleached to the colour of everything else out here. NOT GRASS: nothing is watering downtown Las Vegas | ground | no | — | 2986 |
