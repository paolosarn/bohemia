...
| 23 | `banks/BOHEMIA_LIGHT_TOWER_8_23_26.txt` | `status` | COMMISSIONED ORIGINAL -- the last family both prop matchers refuse |
| 24 | `banks/BOHEMIA_LOGO_CANDIDATES_8_1_26.txt` | `ruling` | Paolo 8/1: "cook me up 10 new Bohemia logos that try to capture the feeling of the game you know I want you to try different fonts different styles I don't wanna see the same font in the same style 10 different times I need you to try 10 unique vastly different logo ideas for Bohemia and the one that you choose I will put on the home screen" |
| 25 | `banks/BOHEMIA_LOGO_CANDIDATES_8_1_26.txt` | `status` | PENDING PAOLO |
| 26 | `banks/BOHEMIA_MARKING_BANK_7_17_26.txt` | `status` | APPROVED-VOLUME (all source classes UP, Paolo 7/17; volume = approved geometry re-weathered, no new shapes) |
| 27 | `banks/BOHEMIA_MARKING_BOLD_CANDIDATES_7_17_26.txt` | `status` | UNJUDGED (Paolo judges on the intersection proof) |
| 28 | `banks/BOHEMIA_OPENINGS_8_2_26.txt` | `status` | PENDING PAOLO |
| 29 | `banks/BOHEMIA_PARTICLE_LOOP_BANK_7_14_26.txt` | `law` | type-matched loops, borders machine-frozen |
| 30 | `banks/BOHEMIA_PARTICLE_LOOP_COOK_7_14_26.txt` | `status` | UNJUDGED |
| 31 | `banks/BOHEMIA_PERIMETER_8_2_26.txt` | `status` | PENDING PAOLO |
| 32 | `banks/BOHEMIA_PERIMETER_WALL_POOL_7_14_26.txt` | `law` | 85% tan / 15% original (Paolo); wall height min 2 tiles; W36/W37 seam-flagged \|\| v2 (7/17): +WB4 (batch-2 sole survivor, Paolo label PERIMETER); weights renormalized over 13 keys; tan variant via the pool-derived tan transform. |
| 33 | `banks/BOHEMIA_POWER_POLE_8_23_26.txt` | `status` | COMMISSIONED ORIGINAL -- cooked because the corpus has none |
...
| 50 | `records/BOHEMIA_STYLE_TARGET_8_1_26.json` | `ruling` | Paolo 8/1: "make as much pixel art that I approve of ... INSPIRED BY THE GRAPHIC ASSETS THAT I BOUGHT TRYING TO REPLICATE THE EXACT LOOK" |
| 51 | `records/BOHEMIA_TUNING_LIST.json` | `law` | laws/BOHEMIA_ADDENDUM_EVERYTHING_COSTS_ONE_8_15_26.md |

TOTAL: 51 rulings across 37 files.
