...
- CLAIMED 9/5 eyes-5vql33  [screenshot diffs]  E3  How studios catch visual regressions by machine: golden images, screenshot diffing, per-tab captures at phone size. Design the pass for every tab of the alpha and the demo, on every ship, with Chromium (it is installed here).
