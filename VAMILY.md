...
- CLAIMED 9/5 session_015Wm1PKCubu8WUBgmB9eXKK  [fortress look]  FORTRESS-TOWN-CAMP-REFERENCE -- what a fortress, a town and a camp LOOK like at our tile size, from real places (a walled compound, a main street, a tent field) and the best games' versions of each; three annotated sheets for COOK, so the faction-towns ruling (9/4) can be cooked to a card, not a guess
