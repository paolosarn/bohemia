...
- CLAIMED 9/5 session_015Wm1PKCubu8WUBgmB9eXKK  [reference library]  THE-REFERENCE-LIBRARY -- one folder per asset kind (district, building, garment, haircut, face, walk cycle, prop, combat ground, UI) holding the best real and pixel references online, each with a one-line note of the structural rule it teaches (windows in a wall plane, a door on the ground); COOK and DIRECTION read from it; nothing from it enters the design vocabulary (8/28)
