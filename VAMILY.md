...
- CLAIMED 9/5 world-9lfjtf  [faction towns]  FACTION-TOWNS -- every faction has a seat that is its market, buildings and quests; FORTRESS / TOWN / CAMP derived from act1_power, draft:true; who sits where is his (9/4 law)
...
- CLAIMED 9/5 sound-xk7pjp  [power hums]  BB-A-LIT-BLOCK-HUMS
...
- CLAIMED 9/5 city-1eztay  [century memory]  CENTURY-RECORD -- persist per-act build totals so act 3's city can differ; mechanism ours, every number his
...
- OPEN  [enter zoom]  HOW-THE-FIGHT-BEGINS -- Paolo 9/5 asked how the overworld becomes a fight now that a combat tile is a house (records/BOHEMIA_HOW_THE_FIGHT_BEGINS_9_5_26.md). MEASURED: the walked world does NOT change scale, the house tile is a COMBAT-BOARD dial only, and the transition already exists and is place-based (street bump -> a STREET board where you stood; through a door -> THAT ROOM with its real walls as cover, starting at the door). What is NOT built is what the player SEES in the half second it turns over. Paolo picks the shape (A camera pulls back from person-scale to house-scale over the same ground, B hard cut, C no transition); build it on the beat at 120 BPM, both directions, same for street and room. Tab: RUN into COMBAT.
...
- OPEN  [who holds]  EVERY-DISTRICT-HAS-AN-OWNER -- DECIDED by the coordinator 9/5, it is NO LONGER "needs Paolo" (records/BOHEMIA_RULING_WHO_HOLDS_WHAT_9_5_26.md). FACTION_ASSIGN ships empty and that emptiness now blocks four jobs; UI built [danger visible] this round and had nothing to point at. THE RULE: rank factions by act1_power (already in engine/BOHEMIA_faction_graph.json, Remnants 14 down to Colorful 1), rank districts by worth (Strip and downtown, then arterials, then industrial edge, then desert), strongest reachable ground wins, ties to the nearest seat. BORDERS FOLLOW SOMETHING YOU CAN SEE: a big road, a rail line, a wash, a wall (real gang borders run on highways and rail, not invisible lines). Mark the edge in the holder's colour. act3_power run through the same rule is the endgame map. Named seats he has ruled stay his; the rest is generated and he corrects it by playing. This is the top of this lane. Tab: MAP and CITY.
...
- CLAIMED 9/5 words-8dqrnq  [trade talk]  Q9  What a former trade sounds like. A dealer, a lineman, a laundry chief, a pit boss: the vocabulary and metaphors a job leaves in a mouth (day 8's background as identity). Test lines for six trades.
...
- CLAIMED 9/5 cook-mce6r5  [runway clothes]  WARDROBE-REMAKE (batches 1-4: 18 new SHAPES + 1 the engine could always draw and nothing wore, 40 garments, wardrobe 79 -> 104 shapes, all 40 inside the style card palette, card headline 32% -> 42%; three regressions this lane caused were found by other lanes' gates and fixed; what is left is one number in the card that is DIRECTION's) -- every garment to the card, NEW SHAPES ONLY (structure law), graveyard stays dead, 10% coat cap stands, colour stays territory; batches through the existing kill/approve pipeline
...
- OPEN  [rent share]  Q14 What share of a family's income goes to the local power boss in a real collapse (Lebanon 44% average, 88% for the poorest, 2023; Iraq by the ampere), how families actually cope (sharing lines, going dark, going solar), and what number in OUR ladder (everything costs one, a day of work pays one battery) makes the block's cut hurt but stay fun. Big swing: is the block's cut the main money sink of the whole game?
...
- CLAIMED 9/5 dynasty-w4yxiz  [time skip]  Q6  The time skip. How to jump ten years and make the player feel it; what the best games do at a cut like ours (the match cut at the table).
...
- CLAIMED 9/5 eyes-5vql33  [audio tells]  E4  How game audio is judged: loudness standards, clipping, phase, noise floor, the tells of a weak sound effect. Render all 65 approved sounds and measure them; list which are weak against the best sounds of their kind.
