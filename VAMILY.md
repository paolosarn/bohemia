...
- SHIPPED 9/5  [crowd moves]  ANIMATE-THE-CROWD -- the valley redraws on the beat while you stand still (renders 1 -> 7 per 3s, 0.2% of a core) and the city cast is baked with a 4-frame breath instead of one still, staggered per person. The 19 animals were already written to move and nothing was asking. In the walked surface AND the demo. records/BOHEMIA_THE_VALLEY_KEEPS_BREATHING_9_5_26.md, gates/valley_breathes_gate.js (8 claims, 3 mutations caught)
