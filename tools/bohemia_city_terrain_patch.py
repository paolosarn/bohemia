...
NEW_REG = ("const KIT_ROAD={strip:1};\n"
...
print('TERRAIN PATCH: desert and wash now draw themselves from their own generators')
print('    the block coordinate is passed as cellX/cellY, so the global field still seams')
print('    mountain and water are deliberately excluded -- reasons in the record')
