...
DESC = {
 ...
 'terminal':   'A passenger transit terminal — bus bays, boarding canopy, layover yard (distinct from the freight railyard).',
 ...
 'cityhall':   'City Hall — the municipal executive/administrative seat (distinct from the judicial courthouse).',
