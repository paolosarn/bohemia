...
STYLES = r'''    /* ===== HAIR (8/1): 26 SHAPES. The category had exactly ONE (his painted
    ...
    {n:'SHAVED FADE',st:'canon',layer:'hair',gen:function(g){return genHair(g,{ramp:H_BRN,vol:0,side:0.22,front:0.12});}},
    {n:'CROP',st:'canon',layer:'hair',gen:function(g){return genHair(g,{ramp:H_BRN,vol:1,side:0.44,front:0.20});}},
    {n:'FLATTOP',st:'canon',layer:'hair',gen:function(g){return genHair(g,{ramp:H_BLK,vol:2,side:0.30,front:0.10});}},
    {n:'POMPADOUR',st:'canon',layer:'hair',gen:function(g){return genHair(g,{ramp:H_BLK,vol:3,side:0.40,front:0.08});}},
    ...
    {n:'CHIN BOB',st:'canon',layer:'hair',gen:function(g){return genHair(g,{ramp:H_BLK,vol:0,side:1.02,front:0.26});}},
    ...
    {n:'LIBERTY SPIKES',st:'canon',layer:'hair',gen:function(g){return genHair(g,{ramp:H_ACD,vol:3,side:0.28,front:0.08,strip:3,tex:'locs'});}},
    {n:'AFRO',st:'canon',layer:'hair',gen:function(g){return genHair(g,{ramp:H_BLK,vol:3,side:0.72,front:0.24,flare:0.30});}},
    {n:'HIGH TOP',st:'canon',layer:'hair',gen:function(g){return genHair(g,{ramp:H_BLK,vol:3,side:0.32,front:0.12,strip:4});}},
    {n:'LOCS',st:'canon',layer:'hair',gen:function(g){return genHair(g,{ramp:H_BLK,vol:1,side:2.10,front:0.20,tex:'locs'});}},
    {n:'CORNROWS',st:'canon',layer:'hair',gen:function(g){return genHair(g,{ramp:H_BLK,vol:0,side:0.50,front:0.16,tex:'braid'});}},
    {n:'BRAIDED TAIL',st:'canon',layer:'hair',gen:function(g){return genHair(g,{ramp:H_BRN,vol:0,side:0.48,front:0.18,tex:'braid',tie:'pony'});}},
    {n:'PONYTAIL',st:'canon',layer:'hair',gen:function(g){return genHair(g,{ramp:H_SND,vol:1,side:0.46,front:0.20,tie:'pony'});}},
    {n:'TOP KNOT',st:'canon',layer:'hair',gen:function(g){return genHair(g,{ramp:H_BLK,vol:0,side:0.40,front:0.16,tie:'top'});}},
    {n:'LOW BUN',st:'canon',layer:'hair',gen:function(g){return genHair(g,{ramp:H_GRY,vol:0,side:0.60,front:0.22,tie:'bun'});}},
