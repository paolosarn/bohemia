...
STYLES = r'''    /* ===== HAIR (8/1): 26 SHAPES. The category had exactly ONE (his painted
    ...
    {n:'SIDE PART',st:'cook',layer:'hair',gen:function(g){return genHair(g,{ramp:H_SND,vol:1,side:0.50,front:0.26});}},
    ...
    {n:'LIBERTY SPIKES',st:'cook',layer:'hair',gen:function(g){return genHair(g,{ramp:H_ACD,vol:3,side:0.28,front:0.08,strip:3,tex:'locs'});}},
    {n:'HAIR AFRO',st:'dead',layer:'hair',gen:function(g){return genHair(g,{ramp:H_BLK,vol:3,side:0.72,front:0.24,flare:0.30});}},
    {n:'HIGH TOP',st:'cook',layer:'hair',gen:function(g){return genHair(g,{ramp:H_BLK,vol:3,side:0.32,front:0.12,strip:4});}},
    {n:'HAIR LOCS',st:'cook',layer:'hair',gen:function(g){return genHair(g,{ramp:H_BLK,vol:1,side:2.10,front:0.20,tex:'locs'});}},
    ...
    {n:'PONYTAIL',st:'cook',layer:'hair',gen:function(g){return genHair(g,{ramp:H_SND,vol:1,side:0.46,front:0.20,tie:'pony'});}},
    {n:'TOP KNOT',st:'cook',layer:'hair',gen:function(g){return genHair(g,{ramp:H_BLK,vol:0,side:0.40,front:0.16,tie:'top'});}},
    {n:'LOW BUN',st:'cook',layer:'hair',gen:function(g){return genHair(g,{ramp:H_GRY,vol:0,side:0.60,front:0.22,tie:'bun'});}},
