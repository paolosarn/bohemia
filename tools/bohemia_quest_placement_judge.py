...
MODFILE = {k: 'engine/bohemia_%s.js' % ('suburb' if k in ('gated', 'estate') else k)
           for k in ('suburb', 'gated', 'estate', 'apartment', 'commercial', 'industrial',
                     ...
                     'battery', 'terminal', 'arterial', 'freeway', 'desert', 'mountain', 'water', 'airport', 'airbase')}
...
MODMAP = {
    ...
    'terminal': 'BohemiaTerminal', 'arterial': 'BohemiaArterial', 'freeway': 'BohemiaFreeway', 'desert': 'BohemiaDesert', 'mountain': 'BohemiaMountain', 'water': 'BohemiaWater', 'airport': 'BohemiaAirfield', 'airbase': 'BohemiaAirfield',
}
