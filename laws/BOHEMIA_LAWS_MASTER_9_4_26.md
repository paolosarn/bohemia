# BOHEMIA LAWS MASTER (9/4/26) -- THE LONG FORM FOLDED OUT OF CLAUDE.md
# Every word below was in CLAUDE.md until 9/4/26 and was moved here VERBATIM so the
# file every chat loads on every turn could be a lookup table instead of a history
# (Paolo 9/4: "I don't want a bunch of tokens being used just for the uplifting of this
# work structure"). NEWEST DATE WINS still applies to every ruling in here; the
# individual law files in laws/ remain the primary text. Nothing was deleted.


# ==== FOLDED SECTION: THE OPENING PILLARS (NO RUNS, THE DYNASTY, THE COMPANION, THE BOSSES, COMBAT IS ONE SENTENCE) ====
...
# ==== FOLDED SECTION: THE LAWS THAT GOVERN EVERYTHING (full text) ====
...
# ==== FOLDED SECTION: THE PLAYTEST DISPATCH (Paolo 8/25/26, LOCKED — he played the run and ====



# ==== FOLDED SECTION: filed ten things at once; second big dispatch after 7/29's BIG MISSING). ====



# ==== FOLDED SECTION: THE FRAME IS THE IMPORTANT PART: "I KNOW WE MADE EVERYTHING REALISTIC AS ====



# ==== FOLDED SECTION: FUCK... BUT I REALLY DO BELIEVE I MAY BE AT A TURNING POINT BECAUSE WE ====



# ==== FOLDED SECTION: NEED TO MAKE THIS GAME FUCKING FUN." REALISM FIRST (8/4) always said ====



# ==== FOLDED SECTION: realism is sacrificed only for fun and THE TRADE IS HIS. HE JUST MADE IT. ====



# ==== FOLDED SECTION: From here FUN CARRIES THE TIE unless he says otherwise on a specific item. ====



# ==== FOLDED SECTION: The ten: (1) the wall changed under him AND there is no wall-opacity ====



# ==== FOLDED SECTION: system at all, though he thinks there is -- build the fade; (2) quests are ====



# ==== FOLDED SECTION: not wired to places or people, and the ASCII "text-cam" feed art is DEAD; ====



# ==== FOLDED SECTION: (3) HAIR GOES TO REFERENCE FIRST, all 8 directions, before another cook; ====



# ==== FOLDED SECTION: (4) STREETS CONNECT LIKE LEGO -- every piece declares its edge connectors, ====



# ==== FOLDED SECTION: art and path are ONE contract, machine-checked; (5) the city is dead and ====



# ==== FOLDED SECTION: DEAD IS NOT THE DEFAULT (a slider is not an answer); (6) THE ACTION BUTTON ====



# ==== FOLDED SECTION: IS NOT THE CITY BUTTON -- zoom is the way in and out; (7) performance; ====



# ==== FOLDED SECTION: (8) ENEMIES, LOOT, and Valheim-style DANGER BY PLACE, with the bestiary ====



# ==== FOLDED SECTION: research delivered same turn; (9) THE UI LANE EXISTS NOW (first word ====



# ==== FOLDED SECTION: "ui") -- he crafts the Bohemia look WITH me; (10) animations get an audit ====



# ==== FOLDED SECTION: and FACE CUSTOMISATION, never built, is on the board. ====



# ==== FOLDED SECTION: Full law: laws/BOHEMIA_ADDENDUM_THE_PLAYTEST_DISPATCH_8_25_26.md ====



# ==== FOLDED SECTION: Bestiary research: records/BOHEMIA_RESEARCH_WHAT_LIVES_IN_A_CITY_OF_CORPSES_8_25_26.md ====




# ==== FOLDED SECTION: THE DEMO IS ITS OWN LINK (Paolo 8/25/26, LOCKED): "THE DEMO WILL BE A ====



# ==== FOLDED SECTION: STANDALONE LINK THAT ISNT THIS WORKSHOP LINK... WE ARE NOT READY FOR THE ====



# ==== FOLDED SECTION: DEMO YET." TWO SURFACES, and they are not the same thing. THE WORKSHOP is ====



# ==== FOLDED SECTION: slices/BOHEMIA_ALPHA_0_9.html, seventeen tabs, HIS bench, governed by the ====



# ==== FOLDED SECTION: ONE-LINK LAW below. THE DEMO is a SEPARATE PUBLISHED BUILD at a SEPARATE ====



# ==== FOLDED SECTION: URL with ZERO dev tabs -- cut from the workshop, never forked (one engine, ====



# ==== FOLDED SECTION: one canon). THE WORKSHOP LINK IS NEVER GIVEN TO A PLAYER: handing somebody ====



# ==== FOLDED SECTION: the bench is handing them sixteen doors and asking them to guess. The ====



# ==== FOLDED SECTION: coordinator planned three sweeps of a friends round around the workshop ====



# ==== FOLDED SECTION: link; that was the error this law exists to kill. And "the demo plays" ====



# ==== FOLDED SECTION: measured INSIDE the workshop is not the claim that a demo exists -- the ====



# ==== FOLDED SECTION: 8/4 plan already said it, item 9: THE DEMO IS A BUILD, NOT A VIBE. ====



# ==== FOLDED SECTION: Full law: laws/BOHEMIA_ADDENDUM_THE_DEMO_IS_ITS_OWN_LINK_8_25_26.md ====



# ==== FOLDED SECTION: Gap list: records/BOHEMIA_WHAT_THE_DEMO_IS_STILL_MISSING_8_25_26.md ====



# ==== FOLDED SECTION: Gate: demo_build_gate (routed SHARED -14) ====




# ==== FOLDED SECTION: WHAT EVERY CHAT DOES FOR THE REST OF THE GAME (Paolo 9/4/26, LOCKED) ====
...
# ==== FOLDED SECTION: THE VAMILY WORD (Paolo 9/4/26, LOCKED) ====
...
# ==== FOLDED SECTION: RESEARCH LANES: VAMILY HAS TWO MODES (Paolo 9/4/26, LOCKED) ====
...
# ==== FOLDED SECTION: EYES AND EARS (Paolo 9/4/26, LOCKED): LANE 17, HIS DOUBLE ====
...
# ==== FOLDED SECTION: THE RUNWAY, AND ART AT ALL TIMES (Paolo 9/4/26, LOCKED) ====
...
# ==== FOLDED SECTION: THE CENTRAL CHAT (Paolo 9/4/26, LOCKED, AMENDS THE COORDINATOR SESSION BELOW) ====
...
# ==== FOLDED SECTION: sessions"): if Paolo tells a session "you are the coordinator" (or ====



# ==== FOLDED SECTION: similar), that session is DIFFERENT from every lane above — it does not ====



# ==== FOLDED SECTION: build the game. Read laws/BOHEMIA_SESSION_BRIEF_COORDINATOR_7_24_26.md ====



# ==== FOLDED SECTION: FIRST, before anything else, and follow it exactly: read-only across every ====



# ==== FOLDED SECTION: lane, plain-English status rollups, flags collisions the individual lanes ====



# ==== FOLDED SECTION: can't see each other to catch, drafts (never sends) next-prompts on ====



# ==== FOLDED SECTION: request. Never writes engine/tools/gates/slices code, never pushes to ====



# ==== FOLDED SECTION: main. A trigger named "Bohemia Coordinator Check-In" exists (see ====



# ==== FOLDED SECTION: `list_triggers`) that fires a fresh session into exactly this role on ====



# ==== FOLDED SECTION: demand. ====




# ==== FOLDED SECTION: LAWS ADDED ON MAIN WHILE THE FOLD WAS IN FLIGHT (9/4) ====
